...
public class PortalCamera : MonoBehaviour
{
    ...
    [SerializeField] private int interations = 7; // Number of recursive rendering
    ...
    private void Awake()
    {
        ...
        tempTexture1 = new RenderTexture(Screen.width, Screen.height, 24, RenderTextureFormat.ARGB32); // Temporary Texture 
    ...
    {
        RenderPipeline.beginCameraRendering += UpdateCamera; //Event for default in render pipeline
    }
    ...
    private void RenderCamera(Portal inPortal, Portal outPortal, int iterationId, ScriptableRenderContext SRC)
    {
        ...
        for (int i = 0; i <= iterationId; i++)
        {
            ...
            //Rotate the camera to look through the portal
